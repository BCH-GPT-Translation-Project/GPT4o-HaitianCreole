...
This Haitian Creole-specific work is currently in the publishing process.
...
1. Create a `Translation Units.xlsx` document in the active directory with the following format:
    ...
    | translation001 | HaitianCreole | 343 | Whole | T1 | T2 | 20240802 | 365 | 348 |
    | translation002 | HaitianCreole | 366 | Partial | T2 | T1 | 20240802 | 389 | 376 |
    | translation003 | HaitianCreole | 752 | Whole | T1 | T2 | 20240802 | 781 | 749 |
